...
<div>
  ...
  <el-table id="dataTable" :data="tableData" border style="width: 100%" :summary-method="getSummaries" show-summary :max-height="tableHeight" v-table-sum>
    ...
    <el-table-column v-for="p in priceNames" :key="p" :prop="p" :label="p" width="100">
    </el-table-column>
  </el-table>
</div>
</template>
