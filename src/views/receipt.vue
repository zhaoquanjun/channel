...
<div class="baobiao3">
  ...
  <el-table id="dataTable" :data="tableData" @cell-click="downloadColumn" border style="width: 100%" :show-summary="true" :summary-method="getSummaries" :max-height="tableHeight" v-table-sum>
    ...
    <el-table-column prop="CompleteRate" :formatter="handleNum" label="传票完成率" width="150">
    </el-table-column>
    <el-table-column prop="RejectCount" label="驳票客户数" width="150">
    </el-table-column>
  </el-table>
</div>
</template>
...
export default {
  ...
  methods: {
    ...
    onDownload() {
      ExcelDown().tableToExcel('dataTable', '传票数据统计')
    },
    getSummaries(param) {
      const {
        columns,
