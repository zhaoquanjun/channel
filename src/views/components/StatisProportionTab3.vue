...
<div>
  ...
  <el-table :data="tableData" border style="width: 100%" :summary-method="getSummaries" show-summary v-table-sum>
    ...
    <el-table-column prop="preOrderNum" label="预提单数量" width="110">
    </el-table-column>
    <el-table-column prop="preOrderRate" label="预提单占比" width="110">
    </el-table-column>
    <el-table-column prop="zsNum" label="正式订单数量" width="130">
    </el-table-column>
    <el-table-column prop="zsRate" label="正式订单占比" width="130">
    </el-table-column>
  </el-table>
