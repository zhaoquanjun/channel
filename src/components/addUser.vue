...
export default {
  ...
  methods: {
    ...
    submitForm(formName) {
      ...
      // return ''
      console.log(typeof (this.mainData), 'data')
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          if (!this.ruleForm.RoleId) {
            ...
            if ((this.ruleForm.RoleId === 18 || this.ruleForm.RoleId === 19 || this.ruleForm.RoleId === 26 || this.ruleForm.RoleId === 27) && !this.ruleForm.MainChannelPartitions && !this.ruleForm.MainProvinces && !this.ruleForm.MainCitys && !this.ruleForm.MainChannels) {
              this.$message({
                message: '请选择主数据权限',
                type: 'warning'
              })
